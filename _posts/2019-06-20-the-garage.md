...
{% single_image path: assets/images/the-garage/exterior-view.jpg alt: "Photo of the garage exterior" %}
...
{% single_image path: assets/images/the-garage/crowbar.jpg, alt: "A very large crowbar", caption: "This was an excellent purchase." %}

Most expendable clothing worn, gear donned. It was time, as Monty Don would put it, "to get stuck in".

{% single_image path: assets/images/the-garage/katherine.jpg, alt: "Katherine with safety gear working on demo in the garage" %}
...
{% single_image path: assets/images/the-garage/insulation.jpg, alt: "A removed wall panel with wood shaving insulation behind it", caption: "Cool. Cool cool cool." %}
...
{% single_image path: assets/images/the-garage/knives.jpg, alt: "Two old knives" %}
...
{% single_image path: assets/images/the-garage/wtf.jpg, alt: "A patch of fur with a leather strap" %}
...
{% single_image path: assets/images/the-garage/mess.jpg, alt: "A very messy section of the garage", caption: "The mess of shame." %}
...
{% single_image path: assets/images/the-garage/old_door.jpg, alt: "The old door on the garage" %}
...
{% single_image path: assets/images/the-garage/new_door_interior.jpg, alt: "The new door viewed from the garage interior", caption: "New door, new studs." %}
...
{% single_image path: assets/images/the-garage/new_door.jpg, alt: "The new door installed in the garage, which is noticeably not aligned with the windows or roofline", caption: "This is not an optical illusion. That's… just how it is." %}
...
{% single_image path: assets/images/the-garage/trim.jpg, alt: "The new door with exterior trim" %}
...
{% single_image path: assets/images/the-garage/pegboard_with_cutouts.jpg, alt: "Pegboard with cutouts for the window and outlet box", caption: "Notice the crowbar presiding over its domain." %}
...
{% single_image path: assets/images/the-garage/garden_pegboard.jpg, alt: "Pegboard garden implements on pegs", caption: "I feel prouder of my organization on the near side of this one." %}
...
{% single_image path: assets/images/the-garage/old_tool_rack.jpg, alt: "Large garden tools on hanging rack" %}
...
{% single_image path: assets/images/the-garage/tool_rack_drilled.jpg, alt: "New hole drilled in the rack" %}

Just drill a new hole.

{% single_image path: assets/images/the-garage/tool_rack.jpg, alt: "New tool rack with tools mounted", caption: "Rack mounted, plus some storage hooks and strategically placed nails for the other tools." %}
...
{% single_image path: assets/images/the-garage/storage_shelf.jpg, alt: "A large metal storage shelf" %}
...
{% single_image path: assets/images/the-garage/tire_hooks.jpg, alt: "Storage hooks holding tires and shovels" %}

Hooks on the walls hold bike tires, hoses, and cords.

{% single_image path: assets/images/the-garage/cord_hooks.jpg, alt: "Storage hooks holding extension cords" %}
...
{% single_image path: assets/images/the-garage/bike_rack.jpg, alt: "Freestanding bike racks" %}
...
{% single_image path: assets/images/the-garage/tandem.jpg, alt: "Tandem bike hanging from ceiling hoist" %}
...
{% single_image path: assets/images/the-garage/branch.jpg, alt: "A fallen tree branch that landed on the garage", caption: "This branch tried to kill the garage. It did not succeed." %}
...
{% single_image path: assets/images/the-garage/pbr.jpg, alt: "An old Budweiser sticker" %}
